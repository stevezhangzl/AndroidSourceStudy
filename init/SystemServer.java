//https://cs.android.com/android/platform/superproject/+/android-7.0.0_r1:frameworks/base/services/java/com/android/server/SystemServer.java?hl=zh-cn
...
public final class SystemServer {
    ...
    private void run() {
        ...
        try {
            ...
            startCoreServices();
            startOtherServices();  //分别启动各种类型的System Server
        } catch (Throwable ex) {
            Slog.e("System", "******************************************");
     ...
     * the other functions.
     */
    //引导程序，这里代表系统服务中最核心的那一部分，这些Services之间相互依赖关系比较强，因而需要在一起统一管理启动
    private void startBootstrapServices() {
        ...
        mActivityManagerService.setSystemProcess();  //向ServiceManager注册
