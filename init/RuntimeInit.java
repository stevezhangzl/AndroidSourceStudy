...
public class RuntimeInit {
    ...
    //调用的是AndrdoidRuntime.cpp中的本地函数，是动态注册
    ...
    public static final void zygoteInit(int targetSdkVersion, String[] argv, ClassLoader classLoader)
        ...
        //通用部分初始化，包括设置默认的uncaught exception handler  为HttpURLConnection准备好默认的HTTP User-Agent（User Agent包含了系统浏览器相关的一系列信息，） 开启trac模式等
        commonInit();
        //本地初始化函数，重点， 
        nativeZygoteInit(); 
        //程序运行的'起点'，在这个场景下程序指的是System Servers
        applicationInit(targetSdkVersion, argv, classLoader);


        //经过上面初始化后，程序现在会有两个分支，其一是nativeZygoteInit主导的本地系统服务的启动；另一个则是applicationInit负责的Java层系统服务的启动。
    }
    ...
    private static void applicationInit(int targetSdkVersion, String[] argv, ClassLoader classLoader)
        ...
        //最终调用的是SystemServer的main函数  反射调用
